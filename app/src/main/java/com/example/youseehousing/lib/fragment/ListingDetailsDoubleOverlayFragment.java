...
// */
//public class ListingDetailsDoubleOverlayFragment extends ListingDetailsOverlayFragment {
//
...
////        View v = inflater.inflate(R.layout.fragment_single_overlay, container, false);
////                if (visible) {
